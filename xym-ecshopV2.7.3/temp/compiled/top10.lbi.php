<?php if ($this->_var['top_goods']): ?>
	<h1 class="mod2tit" style="background:url(themes/black_watch/images/cateBg.gif); height:27px; color:#FFF"><?php echo $this->_var['lang']['top10']; ?></h1>
...
?>
		  <li>
			 <div class="first">
			  <div class="fl">
				<font style="color:#F00; font-weight:bold"><?php echo $this->_foreach['top_goods']['iteration']; ?>.</font> <a href="<?php echo $this->_var['goods']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods']['name']); ?>"><?php echo $this->_var['goods']['short_name']; ?></a>
				</div>
