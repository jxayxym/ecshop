<h1 class="mod2tit" style="background:url(themes/black_watch/images/cateBg.gif); height:27px;"><font  style="color:#FFF"><?php echo $this->_var['lang']['view_history']; ?></font></h1>
<div id='history_div'>
